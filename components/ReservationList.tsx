                            ...
                            <div className="flex items-center gap-1 flex-shrink-0">
                                ...
                                {visita.estado !== 'cancelada' && onChangeStatus && (
                                    <button
                                        ...
                                        className="p-1.5 rounded-md transition-colors cursor-pointer group"
                                        style={{ color: 'var(--color-text-secondary)' }}
                                        onMouseOver={(e) => (e.currentTarget.style.background = 'var(--color-danger-light)')}
                                        onMouseOut={(e) => (e.currentTarget.style.background = 'transparent')}
                                        title="Cancelar reserva"
                                    >
                                        <svg className="w-4 h-4 transition-colors group-hover:text-[var(--color-danger)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
